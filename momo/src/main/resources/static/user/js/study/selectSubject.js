 document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('smjrcc').addEventListener('change', function() {
		...
		if(selectedSubject === null || selectedSubject === "smjrcc0"){
			document.getElementById('smjrcc').value = "smjrcc0";
			document.getElementById('smjrcc').text = "값을 선택해주시기 바랍니다.";
